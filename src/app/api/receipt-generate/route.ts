...
const CODE_MAP: Record<string, { rc: string; sk: string }> = {
  ...
  "I001-1": { rc: "309000110", sk: "41" },     // 間接覆髄 26pt          ★追加
  "I001-2": { rc: "309000210", sk: "41" },     // 直接覆髄 86pt          ★追加
  ...
  "I010-1": { rc: "309004610", sk: "41" },     // 歯周基本治療処置 10pt   ★追加
  ...
  "D002-2": { rc: "309001610", sk: "41" },     // 歯周基本検査（10-20歯未満）250pt ★追加
  "D002-3": { rc: "309001710", sk: "41" },     // 歯周基本検査（20歯以上）400pt   ★追加
  ...
  "J000-4": { rc: "310000410", sk: "42" },     // 抜歯（難）470pt        ★追加
  "J000-5": { rc: "310000510", sk: "42" },     // 抜歯（埋伏歯）1080pt
  "J000-6": { rc: "310000310", sk: "42" },     // 残根抜歯（臼歯相当）
  "J001": { rc: "310001110", sk: "43" },       // 歯根端切除 1350pt
  "J001-1": { rc: "310000710", sk: "43" },     // 歯根端切除（前歯小臼歯）800pt  ★追加
  "J001-2": { rc: "310000810", sk: "43" },     // 歯根端切除（大臼歯）1100pt    ★追加
  ...
  "M009-1": { rc: "313024310", sk: "62" },     // 充填（単純）106pt      ★追加
  "M009-2": { rc: "313024410", sk: "62" },     // 充填（複雑）158pt      ★追加
  "M-KEISEI-cr": { rc: "313001210", sk: "61" },// 窩洞形成（単純充填用）88pt ★追加
  // 金属歯冠修復 M010 → sk:63
