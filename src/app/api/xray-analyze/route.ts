...
【重要な方針】
- 見落としより「多めに報告」することを優先する
- 「歯があるかどうか不明」な場合は欠損（missing）として報告する
- 親知らず(18,28,38,48)は写っていなければ全て欠損として報告する
- 補綴物・欠損は必ず全て拾う

分析手順：
1. 上顎右(18→11)→上顎左(21→28)→下顎左(31→38)→下顎右(41→48)の順に全歯をスキャン
2. 補綴物・欠損・う蝕・根管治療・歯周病変を全て記録
3. 確認できない歯・写っていない歯は欠損(missing)として報告
4. 特に重要な所見（即時対応必要）をnotable_findingsに記載
