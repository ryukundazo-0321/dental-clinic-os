...
export default function Home() {
  ...
  const menuItems = [
    ...
    { href: "/checkin", icon: "📱", iconBg: "bg-green-50 text-green-600 group-hover:bg-green-100", title: "受付", desc: "QRチェックイン・受付番号", ready: false },
    { href: "/billing", icon: "💰", iconBg: "bg-purple-50 text-purple-600 group-hover:bg-purple-100", title: "会計", desc: "精算・レセプト管理", ready: false },
    { href: "/monitor", icon: "🖥️", iconBg: "bg-teal-50 text-teal-600 group-hover:bg-teal-100", title: "待合モニター", desc: "待合室表示用画面", ready: false },
  ];
