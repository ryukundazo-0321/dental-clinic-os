...
export default function BillingPage() {
  ...
  useEffect(() => {
    ...
    const ch = supabase.channel("billing-realtime")
      .on("postgres_changes", { event: "*", schema: "public", table: "billing" }, () => loadBillings())
      .subscribe();
  ...
  async function markPaid(billing: BillingRow) {
    ...
    if (rec?.appointment_id) {
      await supabase.from("appointments").update({ status: "billing_done" }).eq("id", rec.appointment_id);
    }
          ...
          <div className="flex-1">
                    ...
                    <button key={b.id} onClick={() => setSelected(b)}
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-bold text-gray-700 text-sm">{getName(b)}</span>
                        </div>
            ...
            {billings.length === 0 && (
              <div className="text-center py-20">
                ...
                <p className="text-xs text-gray-300 mt-2">診察完了（カルテ確定）後に自動的に表示されます</p>
              </div>
            )}
          </div>
                ...
                <div className="bg-gray-900 text-white p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg font-bold">{getName(selected)} 様</p>
                    </div>
                  ...
                  <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-right">
                      <p className="text-xs text-gray-400">患者負担（{Math.round(selected.burden_ratio * 10)}割）</p>
